...
// Build the transactions export URL for a given date range.
// `from` / `to` are plain dates like '2026-06-02' and '2026-07-02'.
...
async function downloadExcel(fileUrl, fileName, outDir = 'downloads') {
